...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		Penalizing the nuclear norm seems to give more sensible results, is easier to implement, and is faster than low rank factorization. For $\lambda=0.5$, there is a much smaller average error of 0.04 between the given data and the prediction.
